      ...
      <div className="container">
        ...
        <main className="">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="flex max-lg:items-center flex-col w-full lg:flex-row">
              {/* Filters */}
              <form className="hidden lg:block w-1/6">
                {filters.map((section) => (
                  <Disclosure
                    key={section.id}
                    as="div"
              ...
              {/* Product grid */}
              <div className=" flexCenter gap-3 lg:w-5/6 w-[95%]  flex-wrap">
                {[
