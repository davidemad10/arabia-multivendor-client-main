    ...
    <Dialog open={isCartOpen} onClose={setSideCart} className="relative z-10">
      ...
      <div className="fixed inset-0 z-10 w-screen ">
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <DialogPanel
            transition
            className={`fixed flex flex-col flexStart h-screen rounded-lg bg-white shadow-xl transition-all data-[closed]:opacity-0 ${
              i18n.dir() === "rtl"
                ? "data-[open]:left-0"
                : "data-[open]:right-0"
            } data-[closed]:translate-x-full data-[enter]:duration-200 data-[leave]:duration-200 data-[enter]:ease-out data-[leave]:ease-in w-96`}
          >
