        ...
        <div className="flexCenter min-h-full p-4">
          ...
          >
            ...
            {buyerRegister.isSuccess ? (
              ...
              <form
                onSubmit={buyerRegisterForm.handleSubmit(onSubmit)}
                className="flexCenter flex-col w-full gap-4"
              >
                <h3 className=" text-start font-bold text-blackText text-3xl">
                  مرحبا بك!
                </h3>
                <div className=" relative gap-1 flexCenter flex-col w-full">
                  ...
                  <span className="text-sm text-Red">
                    {buyerRegisterForm.formState.errors.email?.message}
                  </span>
                </div>
                <button
                  className={`px-8 flexCenter h-12 w-52 font-bold button1 ${
                    buyerRegister.isPending ? "buttonDisabled" : "button1"
                  } `}
                >
                  {buyerRegister.isPending ? (
